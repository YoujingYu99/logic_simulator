...
class Frame(wx.Frame):
    def __init__(self, parent, id=-1, title="WXCSS Frame", pos=wx.DefaultPosition, size=wx.DefaultSize,
...
class StaticText(wx.StaticText):
    def __init__(self, parent, id=-1, label="", pos=wx.DefaultPosition, size=wx.DefaultSize, style=0,
