...
class Gui(wx.Frame):
    ...
    def __init__(self, title, path, names, devices, network, monitors):
        ...
        self.cycle_font = wx.Font(
            11, wx.FONTFAMILY_DEFAULT, 0, 90, underline=False, faceName=""
        )
        self.monitor_font = wx.Font(
            14, wx.FONTFAMILY_DEFAULT, 0, 90, underline=False, faceName=""
        )
        self.run_font = wx.Font(
            12, wx.FONTFAMILY_DEFAULT, 0, 90, underline=False, faceName=""
        )
